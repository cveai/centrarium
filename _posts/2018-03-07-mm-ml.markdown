...
<figure>
<img src="/assets/pics/mm-ml/grow-rclassification.png" alt="Growing classification tree" style="width: 35%; height: 35%">
...
1. Stop when only one point in $R$.
2. Only consider splits resulting in regions with $\ge m$ (say $m=5$) points per region.
3. Stopt when $R_k$ contains only points of one class.
