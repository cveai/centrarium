...
$$\hat{f}(x + v) = f(x) + \nablaf(x)^T v +\frac{1}{2}v^T \nabla^2f(x)v$$

<figure>
<img src="/assets/pics/conv-opt/nt1.png" alt="Newton step interpretation 1" style="width: 80%; height: 80%">
...
<figure>
<img src="/assets/pics/conv-opt/nt1.png" alt="Newton step interpretation 2" style="width: 80%; height: 80%">
