...
즉 $a \in \mathscr{A} - \mathscr{A}_s$에 대해서는 policy의 함숫값이 $\pi(a \vert s) = 0$이 되어야 한다는 사실이다.
...
다른 말로 하면 $q$는 state $s$에서의 action $a$의 "q"uality를 나타내는 수치다 [[5](https://www.quora.com/How-was-the-term-Q-learning-coined)].
...
[5] Quora, [*How was the term "Q-learning" coined?*](https://www.quora.com/How-was-the-term-Q-learning-coined)
