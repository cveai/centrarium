...
<figure>
<img src="/assets/pics/mm-ml/probability-simplex.png" alt="Bayes Risk" style="width: 40%; height: 40%">
<figcaption>
</figcaption>
</figure>
...
${\rm mode} = (\frac{\alpha_1-1}{\alpha_0}, \ldots, \frac{\alpha_n-1}{\alpha_0-n})$
