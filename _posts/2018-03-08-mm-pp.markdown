...
**Definition** $A, B$ are *conditionally independent* given $C$ if 

$$P(A\cap B \vert C) = P(A \vert C)P(B \vert).$$

<figure>
<img src="/assets/pics/mm-pp/cond-ind.png" alt="Conditional independence" style="width: 40%; height: 40%">
<figcaption>Conditional independence
</figcaption>
</figure>

**Remark** Independence $nRightarrow$ conditional independence
