...
Given (a training) data (set) $(x_1, y_1), \ldots, (x_n, y_n)$, $x_i \in \mathbb{R}, y_i \in \\{0, 1\\}$ and given a new data point.
...
<figure>
<img src="/assets/pics/mm-ml/knn.png" alt="Density estimation and Dimensinality reduction" style="width: 80%; height: 80%">
<figcaption>Density estimation and Dimensinality reduction
</figcaption>
</figure>
