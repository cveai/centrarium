...
* $\int /\sum$ : nasty  
**As a whole computing $p(y \vert x, D)$ is often intratible.
Many of the techniques in ML come in the course of different ways to solve this problem or parts of this problem of computation.**
