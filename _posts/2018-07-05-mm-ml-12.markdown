...
<figure>
<img src="/assets/pics/mm-ml/cross-validation.png" alt="Cross validation" style="width: 60%; height: 60%">
</figure>
...
* MDL (Minimum Description Length) : sort of "Occam's razor" principle

All three of these share a lot with the one of the Baeysain approaches (Type 2 MAP):

<figure>
<img src="/assets/pics/mm-ml/occam.png" alt="Occam's razor" style="width: 60%; height: 60%">
</figure>

* VC (Vapnik–Chervonenkis) dimension : for classification
