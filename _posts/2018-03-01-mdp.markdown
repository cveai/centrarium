...
실수가 아닌 수학적 대상 혹은 다른 어떤 집합을 공변역으로 허용하면 수학적 모델을 기술하는데 확실히 편리한 면이 있다. 

확률적 성격 혹은 불확실성을 가진 데이터 (측정에 불확실성도 포함)(의미) --> 함숫값이 실수가 아니어도 된다.
