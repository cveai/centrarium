...
**Definition.** Given $(\Omega, \mathscr{A}, P)$, a <span style="color:red">*random variable*</span> is a function 

$$X: \Omega \rightarrow \mathbb{R}$$

s.t. $\\{\omeaga \in \Omega : X(\omega) \le x\\} \in \mathscr{A}$ for all $x \in \mathbb{R}$.
