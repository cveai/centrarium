...
$${\rm MSE}(\hat{\theta}) = E((\hat(\theta)- \theta)\vert \theta)$$
...
Proof:
<figure>
<img src="/assets/pics/mm-ml/proof-bias-variance.png" alt="Bias-variance" style="width: 60%; height: 60%">
<figcaption>
</figcaption>
</figure>
...
"Natural" estimate of $\theta$: $\delta_1(D) = X$, bias$^2 = 0$, var$ = 1$, MSE$ =1$
"Silly" estimate of $\theta$: $\delta_0(D) = X$, bias$^2 = \theta^2$, var$ = 0$, MSE$ = \theta^2$
